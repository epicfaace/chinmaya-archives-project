...
// define("__CA_LIB_DIR__", "/var/www/htdocs/app/lib");
...
if (!defined("__CA_DB_DATABASE__")) {
	define("__CA_DB_DATABASE__", 'db_dev_chinmaya_archives_project');
}
...
if (!defined("__CA_APP_DISPLAY_NAME__")) {
	define("__CA_APP_DISPLAY_NAME__", "Chinmaya Archives Project");
}
...
if (!defined("__CA_ADMIN_EMAIL__")) {
	define("__CA_ADMIN_EMAIL__", 'webmaster@chinmayamission.com');
}
...
if (!defined("__CA_APP_NAME__")) {
	define("__CA_APP_NAME__", "chinmaya_archives_project");
}
